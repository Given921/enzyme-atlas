...
(function () {
  ...
  const UI = {
    zh: {
      ...
      search_title: '搜索文献',
      search_desc: '当你已有明确对象时，在本平台的收录池中查找。搜索负责“找得到”，首页推荐负责“不会错过”。',
      search_purpose: '支持论文标题、作者、期刊、酶学主题、DOI 与方法关键词。搜索结果不会改变首页的公共推荐排序。',
      ...
      search_idle_note: '可搜索论文标题、作者、期刊、酶学主题、DOI 与方法关键词。',
      ...
      subscribe_eyebrow: 'WEEKLY BRIEFING',
      subscribe_title: '订阅酶学文献周报',
      subscribe_desc: '每周一封。订阅专题仅影响你收到的周报，不改变网站的公共推荐排序。',
      subscribe_label: '邮箱地址',
      subscribe_confirm: '保存订阅 →',
      subscribe_ok: '订阅偏好已保存：每周一发送，且不会改变公共推荐排序。',
      subscribe_bad_email: '请输入有效的邮箱地址。',
    ...
    en: {
      ...
      search_desc: 'When you already know the target, look it up in the intake pool. Search helps you find it; the homepage helps you not miss it.',
      search_purpose: 'Supports titles, authors, journals, enzymology topics, DOIs and method keywords. Search results never change the public ranking on the homepage.',
      ...
      search_idle_note: 'Search titles, authors, journals, enzymology topics, DOIs and method keywords.',
      ...
      subscribe_eyebrow: 'WEEKLY BRIEFING',
      subscribe_title: 'Subscribe to the weekly enzyme briefing',
      subscribe_desc: 'One email per week. Topic preferences shape your briefing only; they never change the public ranking.',
      subscribe_label: 'Email address',
      subscribe_confirm: 'Save subscription →',
      subscribe_ok: 'Preferences saved: sent every Monday, and the public ranking stays unchanged.',
      subscribe_bad_email: 'Please enter a valid email address.',
